0000<%@page contentType="text/html;charset=UTF-8"%>
...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="com.pragati.services.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        com.pragati.services.Hello getHello10mtemp = sampleHelloProxyid.getHello();
