...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.pragati.services.HelloService {
    ...
    public com.pragati.services.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.pragati.services.HelloSoapBindingStub _stub = new com.pragati.services.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.pragati.services.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.pragati.services.HelloSoapBindingStub _stub = new com.pragati.services.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.pragati.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.pragati.com", "Hello"));
        }
